        ...
        <div class="row">
          <div class="col-sm">
            <div class="card" style="width: 18rem;">
              <img class="card-img-top" src="https://drive.google.com/uc?export=view&id=1w0Feao16LfsX1P2mxW0X1_AWozHQ1O2C" alt="Card image cap">
              <div class="card-body">
                <h5 class="card-title">2021 Mercedes-AMG GT Black Series</h5>
                <p class="card-text">Class: Super</p>
                <p class="card-text">Rental Price (Per Day): $300.57</p>
          ...
          <div class="col-sm">
            <div class="card" style="width: 18rem;">
              <img class="card-img-top" src="https://drive.google.com/uc?export=view&id=1E0Pu_BcV5ZLPiq_VMhOOn8qdDV9pcIY5" alt="Card image cap">
              <div class="card-body">
                <h5 class="card-title">2023 Lamborghini WR-Blue Series</h5>
                <p class="card-text">Class: SUV</p>
                <p class="card-text">Rental Price (Per Day): $250.99</p>
                <p class="card-text"> 5 seater SUV, straight from Lamborghini's factory. An SUV for
                  hauling your friends around but with luxuries and perfromance of a supercar.
                </p>
                <a href="#" class="btn btn-primary">Rent</a>
              </div>
            </div>
          ...
          <div class="col-sm">
            <div class="card" style="width: 18rem;">
              <img class="card-img-top" src="https://drive.google.com/uc?export=view&id=119AL8T61Q88O4CbtY_0RcimPCrNSZPPd" alt="Card image cap">
              <div class="card-body">
                <h5 class="card-title">Lemon Mobile</h5>
                <p class="card-text">Class: Lemon</p>
                <p class="card-text">Rental Price (Per Day): 69.69</p>
                <p class="card-text">A Little Bit of Lemon is good for everyone. Equiped with a 1500 Horse power Lemon Engine which runs on lemonade, this car is no joke.
                You may ask yourself,"why would anyone drive a lemon?" or "Is this even practical?"
                And our answer to that is: It doesn't need be practical or make sense, Its a lemon car! 
                </p>
                <a href="#" class="btn btn-primary">Rent</a>
    ...
    <div class="container-fluid">
      <div class="container">
        <div class="row">
          <div class="col-sm">
            <div class="card" style="width: 18rem;">
              <img class="card-img-top" src="https://drive.google.com/uc?export=view&id=19LOAC5ULJN7S8dz9Ejp1CCQ-uF4Zgv6p" alt="Card image cap">
              <div class="card-body">
                <h5 class="card-title">2023 Mercedes Maybach S Class</h5>
                <p class="card-text">Class: Luxury Sedan</p>
                <p class="card-text">Rental Price (Per Day): $299.99 ($336.44 with optional driver)</p>
                <p class="card-text">The S Class is the ultimate way to ride around town in comfort and style. Equipped with all the features mercedes offers
                  there will never be a dull moment in this car. Make your experience even better with an optional driver.
                </p>
                <a href="#" class="btn btn-primary">Rent</a>
              </div>
          ...
          <div class="col-sm">
            <div class="card" style="width: 18rem;">
              <img class="card-img-top" src="https://drive.google.com/uc?export=view&id=1IxH9rscIFRclA1yN-kNvdEq-Fi5LI8FP" alt="Card image cap">
              <div class="card-body">
                <h5 class="card-title">2017 Ford GT</h5>
                <p class="card-text">Class: Super</p>
                <p class="card-text">Rental Price (Per Day): $287.29</p>
          ...
          <div class="col-sm">
            <div class="card" style="width: 18rem;">
              <img class="card-img-top" src="https://drive.google.com/uc?export=view&id=11rYUdoHFzyZDNou-EG_mMBndN2jrzj6r" alt="Card image cap">
              <div class="card-body">
                <h5 class="card-title">2009 Ford F-350 Platinum Extended Cab Dully Edition 6.4 L V8 Diesel (White)</h5>
                <p class="card-text">Class: Hyper</p>
                <p class="card-text">Built Ford Tough. The F-350 is the most fastest, luxurious vehicle on the planet. The F-350 is the most powerful there is,
                  made for a powerful individual.
                </p>
                <a href="#" class="btn btn-primary">Rent</a>
              </div>
    ...
    <div class="container-fluid">
      <div class="container">
        <div class="row">
          <div class="col-sm">
            <div class="card" style="width: 18rem;">
              <img class="card-img-top" src="https://drive.google.com/uc?export=view&id=1HOoFKQkyUvR_f9hGeHssnNErBx46qzGs" alt="Card image cap">
              <div class="card-body">
                <h5 class="card-title">1994 Toyota Century</h5>
                <p class="card-text">Class: Luxury Sedan</p>
                <p class="card-text">Rental Price (Per Day): $ 420.69 ($457.14 with optional driver)</p>
                <p class="card-text">The Japanese Rolls Royce A one of a kind car. Although old, the Century is still one of the most beautiful cars
                  designed by Toyota. The Century was trully ahead of its time in 1994, introducing many fueatures
                which are found in modern day Rolls Royces. Truly unique car for a unique individual.</p>
                <a href="#" class="btn btn-primary">Rent</a>
              </div>
          ...
          <div class="col-sm">
            <div class="card" style="width: 18rem;">
              <img class="card-img-top" src="https://drive.google.com/uc?export=view&id=1Ywx0z0Dx0RirTP7PYeUFP6ktSnhZ6VXA" alt="Card image cap">
              <div class="card-body">
                <h5 class="card-title">2022 Rolls-Royce Phantom</h5>
                <p class="card-text">Class: Luxury Sedan</p>
                <p class="card-text">Rental Price (Per Day): $420.69 ($457.14 with optional driver)</p>
          ...
          <div class="col-sm">
            <div class="card" style="width: 18rem;">
              <img class="card-img-top" src="https://drive.google.com/uc?export=view&id=1joiJ2KICcmaBrBpCCkvYVWrBbIm2tU23" alt="Card image cap">
              <div class="card-body">
                <h5 class="card-title">2013 McLaren P1</h5>
                <p class="card-text">Class: Super</p>
                <p class="card-text">Rental Price (Per Day): $432.13</p>
                <p class="card-text">Fitted with a twin-turbo V8 paired with a hybrid system, the P1 is an abosulte 
                  monster on the road. McLaren gave the P1 903 Brake Horse Power, capable of pushing the car to 217 mph.
                  The P1 provides a huge rush of adrenaline to anyone sitting inside. For 2013, the P1 was way ahead of it time, using the 
                  hybrid technology to manifest such large amounts of power from the V8. Since 2013, the P1 has not aged a day, as it has a 
                  ageless deisgn that will turn heads everywhere you go.
                </p>
                <a href="#" class="btn btn-primary"> Rent</a>
              </div>
