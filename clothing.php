    ...
    <div class="row">
      <div class="col-sm-auto">
        <div class="card" style="width: 18rem;">
          <img class="card-img-top" src="https://drive.google.com/uc?export=view&id=176D6UqdsNaVXSs67rjyIl-LMV3Urje4q" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title">White Versace Suit</h5>
            <p class="card-text">Rental Price (Per Day): $198.97</p>
            <p class="card-text">This white suit speaks style and fashion. Guarateed to turn heads at any event this
              high-end Versace suit commands respect and attention, worn by many celeberties, such as the fragrance king
              himself, Jeremy Fragrance.</p>
      ...
      <div class="col-sm-auto">
        <div class="card" style="width: 18rem;">
          <img class="card-img-top" src="https://drive.google.com/uc?export=view&id=154F94lUUYyrvT7jV9txmC5L4xUUH61PS" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title">Dior Dream Asymmetric Long Dress</h5>
            <p class="card-text">Rental Price (Per Day): $278.56</p>
            <p class="card-text">Part of the Dior Dream capusule collection, this beautiful white silk dress brings out
              the elegance in any one who wears it, allowing the silhouette to stand out as the wearer radiates a look
              of fashion and sophistication.</p>
            <a href="#" class="btn btn-primary">Rent</a>
      ...
      <div class="col-sm">
        <div class="card" style="width: 18rem;">
          <img class="card-img-top" src="https://drive.google.com/uc?export=view&id=1O8HF_reMymYM92Q3svNybJAyy2AxjzPp" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title">Black Perennial Napoli Suit</h5>
            <p class="card-text">Rental Price (Per Day): $178.67</p>
            <p class="card-text">The Napoli Suit comes in a sleek, timeless black color that exudes sophistication and elegance. It's perfect for a wedding, business meeting, or any formal occasion that requires a touch of class. Crafted from the finest quality materials, this suit is designed to stand the test of time, ensuring you always look sharp and put-together, no matter the occasion.</p>
            <a href="#" class="btn btn-primary">Rent</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-auto">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Rental Price (Per Day): $169.76</p>
            <p class="card-text"></p>
            <a href="#" class="btn btn-primary">Rent</a>
          </div>
        </div>
