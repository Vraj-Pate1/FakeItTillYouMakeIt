...
<body>
  ...
  <div class="row">
    <div class="col-md-6">
<img src="images/How we start.jpg" height="">
    </div>
    <div class="col-md-6">
      <h2 class="about_txt"> What we Offer</h2>
      <h3 class="about_txt"> Homes</h3>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <h3 class="about_txt">Vehicles</h3>
      <p class="about_txt">In addition to housing, Fake it Till You Make it also offers a wide range of luxury vehicles,
        including sports cars, SUVs, and high-end sedans.
        These vehicles are perfect for those who want to make a statement and enjoy
        the thrill of driving a luxurious car.
      </p>
  ...
  <div class="row">
    ...
    <div class="foot">
      <div class="container-fluid">
        <footer  class="footer-expand-lg" style="background: rgb(83, 81, 81); padding: 20px;">
          <div class="container">
            <div class="row">
              <div class="col-md-6">
                <h3>Contact Us</h3>
                <p>Phone: +1(800)-117-1234<br>Email: fitymiUS@bmail.com</p>
              </div>
              <div class="col-md-6">
                <h3>Questions?</h3>
  ...
  <div class="Container-fluid">
    ...
    <p class="about_txt">
      ...
      which offers rental luxury homes, cars, and clothing to those who dream of a millionaire lifestyle,
      came about from a deep understanding of the human desire for experiences and the pursuit of happiness.
      Our founders were inspired by a mutual friend who expressed their disappointment at not being able to afford the
      lifestyle they desired. This sparked
      the idea of creating a business that would allow people to live out their dreams through rental services,
      without the long-term commitment or financial burden of ownership.
    </p>
    ...
    <p class="about_txt">
      Our company has since grown and expanded, but our mission remains the same:
      to provide an elevated experience for our clients and allow them to live their aspirations through our rental
      services. We strive to constantly innovate and offer new and
      exciting experiences to keep our clients coming back for more.
    </p>
    <p class="about_txt">
      Today, our business is a leader in the luxury rental industry,
      providing clients with access to the finest homes, cars, and clothing in the world.
      Our commitment to providing exceptional service and creating unforgettable experiences sets us apart from the
      competition and has made us the go-to choice
      for those looking to live out their millionaire dreams.
    </p>
  </div>
  ...
  <section style="margin:20px">
    ...
    <div class="container">
      ...
      <div class="container text-left">
        <div class="row">
          <div class="col">
            <img src="https://drive.google.com/uc?export=view&id=13H3EWodnPmEj_XZSiXKKEZ5-jZkJUyH6" height="300"
              alt="Vraj">
          </div>
          <div class="col">
            <h3 class="about_txt">Vraj Patel</h3>
            <p class="about_txt"> Vraj is a natural leader. Under his guidance, 
              the company has grown to offer a diverse range of homes, 
              exotic vehicles, and designer clothing, each of which has been carefully curated to meet the highest 
              standards of quality and luxury. He is known for his innovative approach to business and his relentless pursuit of excellence, 
              which has earned the company a reputation for delivering only the best in luxury rentals.
            </p>
          </div>
        </div>
      </div>
      <div class="container">
        <div class="container text-left">
          <div class="row">
            <div class="col">
              <h3 class="about_txt">Harsh Patel</h3>
              <p class="about_txt">Harsh is known for his friendly and approachable demeanor, 
                which has helped him to establish strong relationships with clients and business partners alike. 
                Whether he's working with high-end property owners, premium vehicle manufacturers, or top fashion designers, 
                Harsh always goes the extra mile to ensure that his clients receive the very best in luxury rentals.</p>
            </div>
            <div class="col">
              <img src="https://drive.google.com/uc?export=view&id=1oIUE69LA0cpZl1Bqg579YhZm7ar7A5Ks" height="400"
                alt="Harsh">
            </div>
          </div>
        </div>
        <div class="container">
          <div class="container text-left">
            <div class="row">
              <div class="col">
                <img src="https://drive.google.com/uc?export=view&id=1mtFPokG6aO7aVuUxITWckKpah2EOmhZf" height="300"
                  alt="Jack">
              </div>
              <div class="col">
                <h3 class="about_txt">Jack Finney</h3>
                <p class="about_txt">Jack Finney is a 
                  true marketing wizard who has a deep understanding of what 
                  drives customer engagement and loyalty. Through his visionary approach, 
                  his unwavering commitment to excellence, and his exceptional marketing skills, 
                  Jack has helped to create a company that delivers the ultimate in luxury experiences 
